...
3. Present top 2-3 findings: "I notice a few things that might be causing that feeling: [specific, actionable findings]"
...
SIDE EFFECTS: [None / List of cascading changes]
```
